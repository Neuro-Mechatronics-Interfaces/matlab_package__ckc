...
if strlength(options.DataRoot) == 0
    ...
    poly5_files = [string(fullfile(options.DataRoot,poly5_file_proximal_extensor)); ...
                   string(fullfile(options.DataRoot,poly5_file_distal_extensor)); ...
                   string(fullfile(options.DataRoot,poly5_file_proximal_flexor)); ...
                   string(fullfile(options.DataRoot,poly5_file_distal_flexor))];
end
