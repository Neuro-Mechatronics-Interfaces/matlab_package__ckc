function data = CKC_reader_Max_reader_256_poly5(filepath,filename,epoch_length,options)
%CKC_READER_MAX_READER_256_POLY5 For reading surface EMG acquired by TMSi-SAGA using Polybench and 4x 64 8x8 standard PCB grids.
% 
% SYNTAX:
%   data = CKC_reader_Max_reader_256_poly5(filepath, filename, epoch_length, 'Name', value, ...);
%
% INPUTS:
...
arguments
    ...
    options.ChannelMap {mustBeMember(options.ChannelMap,{'default_tmsi_pcb_64.mat','default_tmsi_pcb_128.mat','default_tmsi_pcb_254_gui_bugfix.mat','default_tmsi_pcb_256.mat'})} = 'default_tmsi_pcb_256.mat';
