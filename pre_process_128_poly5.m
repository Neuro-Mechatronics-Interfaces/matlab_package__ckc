...
arguments
    ...
    options.TriggerBitMask (1,:) {mustBePositive, mustBeInteger} = [2^0, 2^0];
    options.SwappedTextileCables (1,:) logical = false(1,2);
    ...
    options.Description {mustBeTextScalar} = "1-32 = PROX-EXT; 33-64 = PROX-FLX; 65-96 = DIST-EXT; 97-128 = DIST-FLX."
end
